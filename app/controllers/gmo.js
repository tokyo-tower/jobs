...
function refundForSuspend() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const key of Object.keys(reservationInfo)) {
            ...
            // 取引状態参照
            const searchResult = yield GMO.CreditService.searchTrade({
                shopId: process.env.GMO_SHOP_ID,
                shopPass: process.env.GMO_SHOP_PASS,
            ...
            reservationNew.performance_ttts_extension.refund_status = ttts_domain_1.PerformanceUtil.REFUND_STATUS.COMPLETE;
        ...
        for (const performanceId of Object.keys(performanceInfo)) {
            ...
            yield ttts_domain_1.Models.Performance.findOneAndUpdate({
                ...
                $set: {
                    ...
                    'ttts_extension.refund_status': ttts_domain_1.PerformanceUtil.REFUND_STATUS.COMPLETE,
...
function getPerformanceRefundCount(performanceId) {
    return __awaiter(this, void 0, void 0, function* () {
        // パフォーマンス更新
        const performance = yield ttts_domain_1.Models.Performance.findById({
            _id: performanceId
        }).exec();
